...
class VillageJoinInventory : GUI(plugin, 27, "마을 가입") {
    ...
    companion object {
        ...
        private val ICON_HEAD: (Village) -> ItemStack = {
            ItemStackFactory()
    ...
    private val nationList = PagingList(45, VillageRepository.getList())
    private var page = 0
    ...
    override suspend fun setContent() {
        ...
        nationList.getPage(page).forEachIndexed { index, village ->
            setItem(index, ICON_HEAD(village)) {
